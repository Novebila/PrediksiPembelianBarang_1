...
<div class="box box-info">
    ...
    <?php echo form_open_multipart('produk/ubah/' . $produk['id_produk']); ?>
    <div class="box-body">
        ...
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input name="nama_produk" id="nama_produk" class="form-control" type="text" value="<?php echo set_value('nama_produk', $produk['nama_produk']); ?>">
